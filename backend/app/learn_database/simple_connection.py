...
def main() -> None:
    ...
    print(f"Connecting to {cfg['host']}:{cfg['port']} / {cfg['database']} as {cfg['username']}")
    engine = create_engine(build_url(cfg), echo=False, pool_pre_ping=True, pool_recycle=3600)
